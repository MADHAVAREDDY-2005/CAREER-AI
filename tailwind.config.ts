  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        career: {
          ml: "hsl(var(--ml-engineer))",
          web: "hsl(var(--web-developer))",
          cloud: "hsl(var(--cloud-engineer))",
          cyber: "hsl(var(--cybersecurity))",
          data: "hsl(var(--data-scientist))",
          mobile: "hsl(var(--mobile-developer))",
        },
        skill: {
